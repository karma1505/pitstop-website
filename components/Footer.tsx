            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="flex flex-col md:flex-row justify-between items-center gap-6">
                    ...
                    <div className="flex gap-8 text-sm text-gray-600">
                        <Link href="/legal/privacy_policy.pdf" target="_blank" className="hover:text-[#125EB5] transition-colors">Privacy Policy</Link>
                        <Link href="/legal/terms_conditions.pdf" target="_blank" className="hover:text-[#125EB5] transition-colors">Terms of Service</Link>
                        <Link href="mailto:karmanyasingh8@gmail.com" className="hover:text-[#125EB5] transition-colors">Contact Support</Link>
                    </div>
